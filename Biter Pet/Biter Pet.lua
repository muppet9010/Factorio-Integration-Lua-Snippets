/sc local playerName = "muppet9010"; local biterName = "%%USERNAME%%"; local biterDetailsColor = {1.0,1.0,1.0,1.0}; local biterDetailsSize = 1.5; local biterDeathMessageDuration = 600; local biterDeathMessagePrint = "master"; local biterType = "behemoth-biter"; local closenessRange = 5; local exploringMaxRange = 15; local combatMaxRange = 50;
